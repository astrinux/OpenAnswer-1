...
<?php echo $this->Form->create('CcactCallEvent', array('id' => 'addcallevent')); ?>
	...
	<?php
		...
		echo $this->Form->input('CallEvent.event_type', array('type'=> 'hidden', 'value' => '1'));
	?>
	<br><br>
	<div class="is_hidden">
  <input type="submit" value="Add" onclick="saveCustomEvent('/CallEvents/add/<?php echo $this->request->data['CallEvent']['call_id']; ?>');return false"/>
  </div>
  </form>
</div>
<script>
function saveCustomEvent(url) {
      var data = $('#addcallevent').serialize(); 
