...
<?php echo $this->Form->create('CcactCallLog'); ?>
	<fieldset>
		<legend><?php echo __('Edit Ccact Call Log'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('CcactCallLog.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('CcactCallLog.id'))); ?></li>
