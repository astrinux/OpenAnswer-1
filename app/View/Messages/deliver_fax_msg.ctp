...
<table class="coverpage" cellpadding="4" cellspacing="0" width="816">
  <tr><td>To:</td><td><?php echo $this->element('formatPhone2', array('num' => $faxto)); ?></td></tr>
...
echo '<br><br>';
echo '=================================================<br>';
echo 'Message No:' . $message['id'] . "<br>";
echo 'Delivered Date: ' .$local_time.'<br>'; 
echo 'Calltype: '. $message['calltype'] . "<br><br>";
if (!empty($caller_id)) echo 'From: '. $this->element('formatPhone2', array('num' => $caller_id)) . "<br><br>";
echo '-------------------------------------------------<br>';
foreach ($prompts as $p):
	echo $p['caption'] . ': <b>' .$p['value']. "</b><br>";
endforeach;

if (sizeof($appts) > 0) {
  echo '=================================================<br>';
  echo '<b>Appointment</b><br>';
