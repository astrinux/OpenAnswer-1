...
<div class="panel-content">
    		<form name="note_form" id="note-form">
    		<h1>Account Notes</h1>
    		
				<?php echo $this->Form->input('Note.id', array('id' => 'editnote_id', 'type' => 'hidden'));?>    		    		
				<?php echo $this->Form->input('Note.account_id', array('type' => 'hidden'));?>    		
				<?php echo $this->Form->input('Note.did_id', array('type' => 'hidden'));?>    		
				<?php echo $this->Form->input('Note.message_id', array('type' => 'hidden'));?>    		
				
    		
    		<div class="input hrow"><?php echo $this->Form->input('Note.description', array('label' => false, 'type' => 'textarea', 'class' => 'htmleditor', 'maxHeight' => '600', 'minHeight' => '300'));?></textarea>
    		</div>
				<div class="input hrow">	
				<?php 
				echo $this->Form->input('Note.old_visible', array('div' => false, 'type' => 'hidden', 'value' => (isset($this->request->data['Note']['visible'])? $this->request->data['Note']['visible']:'')));
				echo $this->Form->input('Note.visible', array('id' => 'note_visible', 'div' => false, 'type' => 'checkbox', 'label' => false, 'onclick' => "check_note_visibility(this);"));?>&nbsp;&nbsp;Make this note visible on the operator screen
        </div>
        <div id="note_location" class="is_hidden">
				...
				<?php echo $this->Form->input('Misc.visible_when', array('id' => 'note_visible_when', 'default' => '1', 'div' => false, 'type' => 'checkbox', 'label' => false, 'onclick' => "check_note_visibility();"));?>&nbsp;&nbsp;Make this note visible all the time
        </div>

   		<?php
    		echo '<div id="note_time" class="is_hidden"><div class="input">';
				echo $this->Form->input('Misc.start_date', array('type' => 'text', 'div' => false, 'class' => 'datepicker', 'value' => date('Y-m-d')));
				echo '&nbsp;&nbsp;&nbsp;&nbsp;';
				echo $this->Form->input('Misc.start_time', array('type' => 'time',  'interval' => '15', 'div' => false, 'label' => false));
				echo ' EST</div><div class="input">';
				echo $this->Form->input('Misc.end_date', array('type' => 'text', 'div' => false, 'class' => 'datepicker', 'value' => date('Y-m-d')));
				echo '&nbsp;&nbsp;&nbsp;&nbsp;';
