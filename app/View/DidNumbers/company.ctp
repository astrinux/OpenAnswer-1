...
<?php echo $this->Form->create('DidNumber'); ?>
		<h1><?php echo h($this->request->data['DidNumber']['account_name']); ?> (<?php echo h($this->request->data['DidNumber']['account_num']); ?>)</h1>
<?php	
		...
		echo $this->Form->input('answerphrase', array('empty' => 'Select', 'options' => $global_options['answerphrases']));
		echo $this->Form->input('did_color');
